...
public class SortInterface_gen {
    ...
    private static void runInterface(String columnarFile, String[] projection, String otherConstraints, String[] scanColumns, String[] scanTypes, String[] scanConstraints, String[] targetColumns, String sortColumn, String sortOrder, int bufferSize, int numPages) throws Exception {
        ...
        int sortColNumber = cf.getAttributePosition(sortColumn);
        cf.close();
        Iterator it = null;
        ...
        try {
            if (scanTypes[0].equals(FILESCAN)) {
                ...
                csort = new ColumnarSort(cf.getAttributes(), (short) cf.getAttributes().length, cf.getStrSize(), it, sortColNumber+1, tupleSortOrder, cf.getAttrsizeforcolumn(sortColNumber),numPages);
