...
public class ColumnarIndexScan extends Iterator{
    ...
    public ColumnarIndexScan(IndexType index,
                             ...
                             CondExpr[] selects,
                             boolean indexOnly,
                             short[] targetedCols) throws IndexException, UnknownIndexTypeException, IOException, HFException, HFBufMgrException, HFDiskMgrException, SortException {
        ...
        switch (_index.indexType) {
            case IndexType.B_Index:
                Iterator im = new ColumnarBTreeScan(columnarfile, columnNo, index_selects, indexOnly);
            ...
            case IndexType.BitMapIndex:
                scan = new ColumnarBitmapScan(columnarfile, columnNo, index_selects, indexOnly);
                break;
            case IndexType.None:
            default:
